...
if(participantname.equalsIgnoreCase(name))
{
	...
	<div style=" padding-top: 50%"><font size="30"><center>You have submitted </center></font></div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><span style="font-size: 100px">"<%=score1%>"</span></center> </div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><font size="30"> Please Wait.........</font></center></div>
	<%}else if (judge.equalsIgnoreCase("judge2")){%>
        <div style=" padding-top: 50%"><font size="30"><center>You have submitted </center></font></div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><span style="font-size: 100px">"<%=score2%>"</span></center> </div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><font size="30"> Please Wait.........</font></center></div>
	<%}else if (judge.equalsIgnoreCase("judge3")){%>
        ...
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><span style="font-size: 100px">"<%=score3%>"</span></center> </div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><font size="30"> Please Wait.........</font></center></div>
        ...
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><span style="font-size: 100px">"<%=score4%>"</span></center> </div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><font size="30"> Please Wait.........</font></center></div>
        ...
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><span style="font-size: 100px">"<%=score5%>"</span></center> </div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div><center><font size="30"> Please Wait.........</font></center></div>	<%}%><%
